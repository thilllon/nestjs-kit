...
export declare class BetterAuthService<A extends AuthLike = RegisteredAuth> {
   ...
   * scope, a call that carries the caller's session cookie on an unsafe browser leg whose origin no guard verified, as in a @Public()
   * handler, throws PUBLIC_HANDLER_USED_CALLER_SESSION). [R4:SEC-r4-02]
   */
  readonly api: A["api"];
   ...
   * to a call acting on the caller's session uses @OptionalAuth() or a guarded access, never @Public() on an unsafe route (§7.5). [A] [R4:SEC-r4-02]
   */
 ...
 * and the scope interceptor likewise. With `{ principal }` the stand-in guard writes a test stamp (§7.8 item 4) and returns true.
 ...
 * does no better-auth I/O either. With a CanActivate, that guard runs and may call stampPrincipal(). The replaced global guard still
 * counts for B16, which recognizes the instance the BetterAuthGuard token resolves to, overrides included (§5.4), so stand-ins need no
...
| ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DI tokens                    | `instance:<name>`, `options:<name>`, `service:<name>`, `handle:<name>`, `principal-resolver`, `policy-invoker`, `policy-resolver` (U19) `[R3:NEST-r3-04]`, `transports` (the default `forRoot`'s transport list), `transport-registry` (U6, the core `TransportRegistry` that selects from that list), `platforms`, `principal-sources:<name>`, `instance-registry`, `request-scope`, `mount-coordinator`, `ws-connection-auth`; `ext:<point>:<instance>:<i>` (one provider per extension list entry, §4 and §5.7: e.g. `ext:principals:<name>:<i>`, `ext:platforms:default:<i>`, `ext:transports:default:<i>`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
