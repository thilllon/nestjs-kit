...
implementation follows. Version 1.0.0 implements its HTTP scope, and the `./websockets`
entry adds Socket.IO and raw `ws` gateways; GraphQL and RPC transports and the conformance
kit are still to come.
