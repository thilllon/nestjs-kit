...
implementation follows. The package implements its HTTP scope and GraphQL transports;
WebSocket and RPC transports and the conformance kit are still to come.
