...
- The maintainer decided on September 23, 2026 to release the HTTP scope as `1.0.0` rather than waiting for the complete library. The conformance testing kit (issue #545) ships as a later minor version behind its own entry point, because new entry points are additive.
