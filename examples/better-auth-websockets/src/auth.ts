...
/**
 * Application users sign up under /api/auth and connect to the default
 * namespace. bearer() accepts the session token that a Socket.IO client sends
 * as `auth.token`.
 */
 ...
 * and cookie prefix, and connect to the /admin namespace. Neither instance
 * accepts the other's session.
 */
